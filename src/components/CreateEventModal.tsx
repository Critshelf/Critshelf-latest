            ...
            >
              ...
              <div className="space-y-4 pt-4 border-t border-white/5">
                <div className="flex items-center justify-between ml-2">
                  <label className="text-xs font-black text-white/20 uppercase tracking-widest">
                    Games To Bring (Optional)
                  </label>
                  <span className="text-[10px] font-black text-emerald-accent uppercase tracking-widest bg-emerald-accent/10 px-2 py-0.5 rounded-md">
                    Host List
                  </span>
                </div>
                ...
                <div className="relative">
                  ...
                  />
                  {isSearching && (
                    <Loader2 className="absolute right-6 top-1/2 -translate-y-1/2 w-4 h-4 text-emerald-accent animate-spin" />
                  )}
                </div>
                  ...
                  {broughtGames.map((game) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={() =>
                          setBroughtGames(
                            broughtGames.filter((g) => g.id !== game.id),
                          )
                        }
                    ...
                    >
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          >
                            <option value="weekly" className="bg-charcoal">
                              Weekly
                            </option>
                            <option value="bi-weekly" className="bg-charcoal">
                              Bi-Weekly
                            </option>
                            <option value="monthly" className="bg-charcoal">
                              Monthly
                            </option>
                          </select>
                        </div>
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setOccurrenceCount(parseInt(e.target.value) || 2)
                            }
                          />
                        </div>
                      </div>
                      <div className="bg-emerald-accent/5 p-4 rounded-2xl border border-emerald-accent/10">
                        ...
                        <p className="text-xs text-white/40 mt-1 font-medium">
                          This will create {occurrenceCount} separate events in
                          your group schedule.
                        </p>
                      </div>
                    </motion.div>
