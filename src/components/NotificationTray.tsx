...
import { Notification, markAllAsRead, markAsRead } from '../services/notificationService';
      ...
      {isOpen && (
        ...
        >
              ...
              notifications.map((notif) => (
                ...
                >
                  ...
                  <div className={cn(
                    ...
                    notif.type === 'moderation' ? "bg-blue-500/10 border-blue-500/20 text-blue-500" :
                    notif.type === 'social' ? "bg-amber-500/10 border-amber-500/20 text-amber-500" :
                    notif.type === 'library' ? "bg-emerald-accent/10 border-emerald-accent/20 text-emerald-accent" :
          ...
          <div className="p-4 bg-white/5 border-t border-white/10 text-center">
            <p className="text-[8px] font-black text-white/20 uppercase tracking-[0.2em]">End of Transmission</p>
          </div>
        </motion.div>
      )}
    </AnimatePresence>
